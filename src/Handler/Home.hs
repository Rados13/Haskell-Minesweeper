...
gameAForm = GameSettings
    ...
    <*> areq naturalField "Seed for generator" (Just 10)
    <*> areq sizeField "Size (max 60)" (Just 10)
    where 
        ...
        sizeField = checkBool (<=60) errorMessageSize naturalField
...
postHomeR = do
    ...
    case result of
        FormSuccess res -> redirect $ GenerateMapR res
        _ -> redirect HomeR
